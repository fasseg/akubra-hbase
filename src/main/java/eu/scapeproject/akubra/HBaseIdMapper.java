...
public class HBaseIdMapper implements IdMapper{
    private static final Logger log=LoggerFactory.getLogger(HBaseIdMapper.class);
    private final String storeId;

    public HBaseIdMapper(final BlobStore store) {
